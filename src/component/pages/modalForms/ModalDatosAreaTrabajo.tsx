                ...
                <div className='flex flex-col gap-3'>
                    <div className='bg-gray-200 w-full rounded-lg flex p-2 justify-between'>
                        <div className='flex'>
                            ...
                            <span className='ml-4 font-bold text-xl my-auto'>DATOS DEL ÁREA DE TRABAJO</span>
                        </div>
                        ...
                        <div className='flex flex-col'>
                            ...
                            <div className="grid grid-cols gap-2">
                                <div className="flex w-full justify-between">
                                    <div className='flex'>
                                        <i className="bi bi-dot my-auto text-2xl" />
                                        <label htmlFor="horaInicio1" className='font-semibold my-auto'>
                                            Turno 1
                                        </label>
                                    </div>
                                    <div>
                                        <input type="time" id="horaInicio1" name="horaInicio1" />
                                        <span className='mx-4 text-center font-semibold'>-</span>
                                        <input type="time" id="horaFin1" name="horaFin1" />
                                    </div>
                                </div>
                                <div className="flex w-full justify-between">
                                    <div className='flex'>
                                        <i className="bi bi-dot my-auto text-2xl" />
                                        <label htmlFor="horaInicio2" className='font-semibold my-auto'>
                                            Turno 2
                                        </label>
                                    </div>
                                    <div>
                                        <input type="time" id="horaInicio2" name="horaInicio2" />
                                        <span className='mx-4 text-center font-semibold'>-</span>
                                        <input type="time" id="horaFin2" name="horaFin2" />
                                    </div>
                                </div>
                                <div className="flex w-full justify-between">
                                    <div className='flex'>
                                        <i className="bi bi-dot my-auto text-2xl" />
                                        <label htmlFor="horaInicio3" className='font-semibold my-auto'>
                                            Turno 3
                                        </label>
                                    </div>
                                    <div>
                                        <input type="time" id="horaInicio3" name="horaInicio3" />
                                        <span className='mx-4 text-center font-semibold'>-</span>
                                        <input type="time" id="horaFin3" name="horaFin3" />
                                    </div>
                                </div>
                            </div>
                        </div>
