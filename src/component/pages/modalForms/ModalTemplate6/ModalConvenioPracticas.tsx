...
const ModalConvenioPracticas: React.FC<Props> = ({ show, hide, changeInit }) => {
    ...
    const handleGuardarCambios = () => {
        ...
        if (selectedFile) {
            ...
            const nombreArchivo: string = "CP-" + codigo + "-" + anio + per + "-" + codAsig + ".pdf"
                ...
                if (value) {
                    ...
                    if (response instanceof Response) {
                        if (response.data.value == "procesado") {
                            sweet.openSuccess("¡Operación completada con éxito!", "El convenio de prácticas ha sido cargado satisfactoriamente.", () => {
                                changeInit()
                                hide()
                            })
                        }
        ...
        <Modal onShow={show}>
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className='bg-gray-100 w-full rounded-lg flex p-2 justify-between'>
                        <div className='flex text-upla-100'>
                            ...
                            <span className='ml-4 font-bold sm:text-xl my-auto'>CONVENIO DE PRÁCTICAS</span>
                        </div>
            ...
            <Modal.Footer>
                <div className="w-full lg:gap-3 flex sm:justify-end">
                    ...
                    >
                        Registrar CONVENIO DE PRÁCTICAS
                    </button>
                </div>
            </Modal.Footer>
        </Modal>
...
export default ModalConvenioPracticas