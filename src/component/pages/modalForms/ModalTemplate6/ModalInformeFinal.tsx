                ...
                if (value) {
                    ...
                    if (response instanceof Response) {
                        if (response.data.value == "procesado") {
                            sweet.openSuccess("¡Operación completada con éxito!", "El informe final ha sido cargado satisfactoriamente.", () => {
                                changeInit()
                                hide()
                            })
                        }
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <div className='bg-gray-100 w-full rounded-lg flex p-2 justify-between'>
                        <div className='flex text-upla-100'>
                            ...
                            <span className='ml-4 font-bold sm:text-xl my-auto'>INFORME FINAL</span>
                        </div>
...
export default ModalInformeFinal