...
import RegistrarNotasGeneralExcel from "./RegistrarNotasGeneralExcel";


const BuscarAulasAsignaturasExcel = () => {
                            ...
                            moduloRegistroNotas ?
                                (
                                    ...
                                    <div className="p-1 bg-Solid">
                                        <h2 className="text-2xl font-bold mb-6"><span onClick={() => navigate(-1)} title="Atrás" role="button"><i className="bi bi-arrow-left-circle-fill text-blue-500"></i></span> Buscar Aulas Asignaturas Excel</h2>
...
export default BuscarAulasAsignaturasExcel
