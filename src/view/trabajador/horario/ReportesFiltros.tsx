...
const Reporte = () => {
    ...
    console.log(reporteDisponibles)
    
    // const listaTransformada = reporteDisponibles.map((item) => ({
    //     Periodo: item.anio - item.mes,
    //     Modalidad: item.modalidad,
    //     TipoEstudio: item.tipoEstudiotem,
    //     Aula: item,
    //     Seccion: item,
    //     Turno: item,
    //     Asignatura: item,
    ...
    const handleDownload = () => {
        ...
        const ws = XLSX.utils.json_to_sheet(reporteDisponibles);
    
        // Añadir la hoja al libro
        XLSX.utils.book_append_sheet(wb, ws, 'Hoja1');
    
        // Guardar el libro como archivo Excel
        XLSX.writeFile(wb, 'archivoExcel.xlsx');
      };
                            ...
                            <div>
                                ...
                                <div className="flex">
                                    ...
                                    <div className="relative flex flex-wrap">
                                        ...
                                        >
                                            <i className="bi bi-search mr-1"></i> GENERAR REPORTE
                                        </button>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        reporteDisponibles.length == 0 ?
                                            (
                                                <tr className="text-center bg-white border-b">
                                                    ...
                                                    <td colSpan={13} className="text-sm p-2  border-b border-solid">No hay datos disponibles</td>
                                                </tr>
                                            )
                                            :
                                            (
