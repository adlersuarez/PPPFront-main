    ...
    return (
        <>
            ...
            <div className="flex flex-wrap -mx-3">
                <div className="w-full max-w-full px-3 sm:flex-0 shrink-0 sm:w-6/12 lg:w-6/12">
                    <div className="drop-shadow-sm relative flex flex-col min-w-0 mb-6 break-words bg-white dark:bg-gray-950  rounded-md bg-clip-border">
                        <div className="flex-auto p-4">
                            <div className="flex flex-wrap -mx-3">
                    ...
                    <div className="drop-shadow-sm relative flex flex-col min-w-0 break-words bg-white dark:bg-gray-950  rounded-md bg-clip-border">
                        <div className="flex-auto p-4">
                            <div className="flex flex-wrap -mx-3">
                                <div className="flex-none w-2/3 max-w-full px-3">
                                    <div>
                ...
                <div className="w-full max-w-full px-3 mt-6 sm:flex-0 shrink-0 sm:mt-0 sm:w-6/12 lg:w-6/12">
                    <div className="drop-shadow-sm relative flex flex-col min-w-0 mb-6 break-words bg-white dark:bg-gray-950  rounded-md bg-clip-border">
                        <div className="flex-auto p-4">
                            <div className="flex flex-wrap -mx-3">
                                <div className="flex-none w-2/3 max-w-full px-3">
            ...
            {/* <div className="flex flex-wrap mt-6 -mx-3">
                <div className="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
                    <div className="relative z-20 flex flex-col min-w-0 break-words bg-white border-0 border-solid dark:bg-gray-950 border-black-125 drop-shadow-sm  dark:shadow-soft-dark-xl rounded-md bg-clip-border">
                        <div className="flex-auto p-4">
                            <div className="py-4 pr-1 mb-4 bg-gradient-to-tl from-gray-900 to-slate-800 dark:bg-gradient-to-tl dark:from-slate-850 dark:to-gray-850 rounded-xl">
                                <div>
                                    <canvas id="chart-bars" className="chart-canvas box-border block w-[368.3px] h-[170px]" height="212" width="460"></canvas>
                                </div>
                            </div>
                            <h6 className="mt-6 mb-0 ml-2 dark:text-white">Active Users</h6>
                            <p className="ml-2 leading-normal text-sm dark:opacity-60">(<span className="font-bold">+23%</span>) than last week</p>
                                ...
                                <div className="flex flex-wrap mt-0 -mx-3">
                                    <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                        <div className="flex mb-2">
                                            ...
                                            <p className="mt-1 mb-0 font-semibold leading-tight text-xs dark:opacity-60">Users</p>
                                        </div>
                                        ...
                                        <div className="text-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                                            <div className="duration-600 ease-soft -mt-0.4 -ml-px flex h-1.5 w-3/5 flex-col justify-center overflow-hidden whitespace-nowrap rounded-lg bg-slate-700 text-center text-white transition-all" role="progressbar" aria-valuenow={60} aria-valuemin={0} aria-valuemax={100}></div>
                                        </div>
                                    </div>
                                    <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                        <div className="flex mb-2">
                                            ...
                                            <p className="mt-1 mb-0 font-semibold leading-tight text-xs dark:opacity-60">Clicks</p>
                                        </div>
                                        <h4 className="font-bold dark:text-white">2m</h4>
                                        <div className="text-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                                            <div className="duration-600 ease-soft -mt-0.4 w-9/10 -ml-px flex h-1.5 flex-col justify-center overflow-hidden whitespace-nowrap rounded-lg bg-slate-700 text-center text-white transition-all" role="progressbar" aria-valuenow={90} aria-valuemin={0} aria-valuemax={100}></div>
                                        </div>
                                    </div>
                                    <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                        <div className="flex mb-2">
                                            ...
                                            <p className="mt-1 mb-0 font-semibold leading-tight text-xs dark:opacity-60">Sales</p>
                                        </div>
                                        <h4 className="font-bold dark:text-white">435$</h4>
                                        <div className="text-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                                            <div className="duration-600 ease-soft -mt-0.4 w-3/10 -ml-px flex h-1.5 flex-col justify-center overflow-hidden whitespace-nowrap rounded-lg bg-slate-700 text-center text-white transition-all" role="progressbar" aria-valuenow={30} aria-valuemin={0} aria-valuemax={100}></div>
                                        </div>
                                    </div>
                                    <div className="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                        <div className="flex mb-2">
                                            ...
                                            <p className="mt-1 mb-0 font-semibold leading-tight text-xs dark:opacity-60">Items</p>
                                        </div>
                                        <h4 className="font-bold dark:text-white">43</h4>
                                        <div className="text-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                                            <div className="duration-600 ease-soft -mt-0.4 -ml-px flex h-1.5 w-1/2 flex-col justify-center overflow-hidden whitespace-nowrap rounded-lg bg-slate-700 text-center text-white transition-all" role="progressbar" aria-valuenow={50} aria-valuemin={0} aria-valuemax={100}></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div className="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
                    <div className="relative z-20 flex flex-col min-w-0 break-words bg-white border-0 border-solid dark:bg-gray-950 border-black-125 drop-shadow-sm  dark:shadow-soft-dark-xl rounded-2xl bg-clip-border">
                        ...
                        <div className="flex-auto p-4">
                            <div>
                                <canvas id="chart-line" className=" block box-border h-[300px] w-[543.7px]" height="375" width="679"></canvas>
                            </div>
                        </div>
                    </div>
                </div>
