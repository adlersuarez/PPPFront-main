                    ...
                    <div className="flex flex-col visible w-full  min-w-0 p-4 break-words bg-white opacity-100 border rounded-md bg-clip-border">
                        <div className="p-2 ">
                            <h2 className="text-2xl font-bold mb-6">
                                ...
                                <i className="bi bi-person-fill text-lg text-gray-500"></i>
                            </h2>
                            ...
                            <div className='flex justify-around'>
                                <div className='flex w-1/2'>
                                    <h3 className='font-bold w-full m-auto pr-2'>ESTUDIANTE: </h3>
                                    <input
                                        type="text"
                                        className="px-2 py-2 text-gray-500 h-8 my-auto rounded-md w-full"
                                    ...
                                    <div className='flex justify-around'>
                                        <div className='flex'>
                                            ...
                                            <input
                                                type="text"
                                                className="px-4 py-2 text-gray-500 h-8 my-auto rounded-md"
