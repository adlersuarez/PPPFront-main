...
const Paso4: React.FC<{ elementos: Paso4Props }> = ({ elementos }) => {
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-16">
                {
                    elementos.pdfUrl ?
                        ...
                        <div className="text-center sm:col-span-3 p-4 sm:p-8 bg-gray-200 rounded shadow-lg">
                            <p className="text-base sm:text-2xl font-bold text-gray-500">El estudiante aún no ha cargado su Plan de Actividades</p>
                        </div>
                }
            </div>
        </div>
