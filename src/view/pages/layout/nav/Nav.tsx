        ...
        <nav
            ...
            <ul className="flex items-center flex-1 justify-end sm:pr-3 h-full">
                <li className="flex justify-center h-full relative">
                    ...
                    <ul className={`${open ? "block" : "hidden"} absolute h-fit translate-x-[-243px] translate-y-[53px] sm:translate-x-[-270px] inset-0 w-80 bg-white rounded-sm drop-shadow-md`}>
                                            ...
                                            <a className="flex flex-row items-center justify-between px-2 py-5 border-b-2 border-[#ddd] border-solid m-0">
                                                <div className="p-3">
                                                    <div className="flex items-center justify-center relative w-12">
                                                        <div className="absolute left-0"><i className="bi bi-circle-fill text-5xl text-upla-100" /> </div>
                                                        <div className="absolute left-3"><i className="bi bi-chat-dots-fill text-2xl text-white" /></div>
                                                    </div>
                                                </div>
